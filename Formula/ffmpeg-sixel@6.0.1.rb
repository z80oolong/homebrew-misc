class FfmpegSixelAT601 < Formula
  desc "Play, record, convert, and stream audio and video"
  homepage "https://ffmpeg.org/"
  license "GPL-2.0-or-later"
  url "https://ffmpeg.org/releases/ffmpeg-6.0.1.tar.xz"
  sha256 "880825a131ef97da80d44ec2e1ff51264736b041d47b4688d786e5b238862f23"
  revision 5
...
@@ -1845,6 +1846,7 @@ EXTERNAL_LIBRARY_LIST="
     librtmp
     libshaderc
     libshine
+    libsixel
     ...
     libsnappy
     libsoxr
@@ -3544,6 +3546,7 @@ oss_indev_deps_any="sys_soundcard_h"
...
@@ -6676,6 +6679,7 @@ enabled librtmp           && require_pkg_config librtmp librtmp librtmp/rtmp.h R
...
index 2eeebd8..34a678a 100644
--- a/doc/general_contents.texi
+++ b/doc/general_contents.texi
@@ -1469,6 +1469,7 @@ performance on systems without hardware floating point support).
...
index aa41e29..5bdc02f 100644
--- a/doc/outdevs.texi
+++ b/doc/outdevs.texi
@@ -467,6 +467,75 @@ SDL window, forcing its size to the qcif format:
