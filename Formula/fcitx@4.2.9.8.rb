class FcitxAT4298 < Formula
  ...
  depends_on "gtk+"
  depends_on "gtk+3"
  depends_on "z80oolong/misc/qt@4"
  depends_on "qt@5"
  depends_on "intltool"
  depends_on "librsvg"
  depends_on "z80oolong/misc/gconf@3.2.6"
  depends_on "json-c"
  depends_on "pcre"
  depends_on "sqlite"
  depends_on "libxml2"
  ...
  def install
    mkdir "build" do
      system "cmake", "..", "-DCMAKE_INSTALL_PREFIX=#{prefix}", "-DENABLE_X11=ON", "-DENABLE_GTK2_IM_MODULE=ON", "-DENABLE_GTK3_IM_MODULE=ON", "-DENABLE_QT_IM_MODULE=ON"
      system "make", "install"
    end
  end
