class FfmpegSixelAT611 < Formula
...
+    libsixel
     ...
     libsnappy
     libsoxr
@@ -3600,6 +3602,7 @@ oss_indev_deps_any="sys_soundcard_h"
...
@@ -6791,6 +6794,7 @@ enabled librtmp           && require_pkg_config librtmp librtmp librtmp/rtmp.h R
